    ...
    <div>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
          ...
          <button
            onClick={() => initializeTasksMutation.mutate()}
            disabled={initializeTasksMutation.isPending || (tasks && tasks.length > 0)}
            style={{
              padding: '0.5rem 1rem',
              borderRadius: '6px',
              border: 'none',
              ...
              color: '#fff',
              cursor: (initializeTasksMutation.isPending || (tasks && tasks.length > 0)) ? 'not-allowed' : 'pointer',
              fontSize: '0.875rem',
              fontWeight: '500'
            }}
          >
            {initializeTasksMutation.isPending ? 'Generating...' : (tasks && tasks.length > 0) ? 'Tasks Created' : 'Generate Default Tasks'}
          </button>
        </div>
            ...
            <div style={{ display: 'flex', gap: '0.5rem' }}>
              <button
                ...
                style={{
                  ...
                  border: '1px solid #e5e5e5',
                  backgroundColor: '#fff',
                  cursor: updateDetailsMutation.isPending ? 'not-allowed' : 'pointer',
                  fontSize: '0.875rem',
                  fontWeight: '500',
                  color: '#374151'
                }}
              ...
              <button
                onClick={() => updateDetailsMutation.mutate(detailsText)}
                disabled={updateDetailsMutation.isPending}
                style={{
                  padding: '0.5rem 1rem',
                  borderRadius: '6px',
